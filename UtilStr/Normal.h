...
//  XMShop
//
//  Created by 刘玉娇 on 16/3/24.
//  Copyright © 2016年 刘玉娇. All rights reserved.
//

#pragma mark - userdefault
//---------------userdefault----------------------
#define kBUTTON_AUTH       @"default_btn_auth"

#pragma mark - filepath
//---------------file path----------------------
#define kLinkFaceVideo  @"Linkface_liveness_video.mp4"
#define kLinkFaceCompressVideo  @"Linkface_liveness_compress_video.mp4"

#pragma mark - notif
//---------------notif----------------------
#define kNOTIF_NETWORK_DEFINE    @"notif_network_define"
...
#define kCOMMON_FONT_MEDIUM_24   [Util fontWithName:@"PingFangSC-Medium" size:24]
#define kCOMMON_FONT_MEDIUM_25   [Util fontWithName:@"PingFangSC-Medium" size:25]
#define kCOMMON_FONT_MEDIUM_26   [Util fontWithName:@"PingFangSC-Medium" size:26]
#define kCOMMON_FONT_MEDIUM_27   [Util fontWithName:@"PingFangSC-Medium" size:27]
#define kCOMMON_FONT_MEDIUM_30   [Util fontWithName:@"PingFangSC-Medium" size:30]
#define kCOMMON_FONT_MEDIUM_40   [Util fontWithName:@"PingFangSC-Medium" size:40]

#define kCOMMON_FONT_REGULAR_12  [Util fontWithName:@"PingFangSC-Regular" size:12]
#define kCOMMON_FONT_REGULAR_13  [Util fontWithName:@"PingFangSC-Regular" size:13]
#define kCOMMON_FONT_REGULAR_14  [Util fontWithName:@"PingFangSC-Regular" size:14]
#define kCOMMON_FONT_REGULAR_15  [Util fontWithName:@"PingFangSC-Regular" size:15]
#define kCOMMON_FONT_REGULAR_16  [Util fontWithName:@"PingFangSC-Regular" size:16]
#define kCOMMON_FONT_REGULAR_18  [Util fontWithName:@"PingFangSC-Regular" size:18]
#define kCOMMON_FONT_REGULAR_20  [Util fontWithName:@"PingFangSC-Regular" size:20]
#define kCOMMON_FONT_REGULAR_26  [Util fontWithName:@"PingFangSC-Regular" size:26]

#define kCOMMON_FONT_SEMIBOLD_18 [Util fontWithName:@"PingFangSC-Semibold" size:18]
...
#define  UM_KEY  @"5a67f0508f4a9d5eea000025" //UMENG
#define  BAIDU_MAP_KEY   @"KXcuraG678jTjfzmZlC9OfCDIAcrSNHX"

#define   SJMH_KEY       @"1b2007c8ae0d490e9e2f089a1195adf2"
#define   SJMH_CODE      @"yunbeifq_mohe"
